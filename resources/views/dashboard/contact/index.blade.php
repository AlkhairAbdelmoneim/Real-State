                ...
                <form action="{{route('contact_us.index')}}" method="GET">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                    ...
                                    <a href="{{route('contact_us.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i>@lang('site.add')</a>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="box-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{$msg ->getStatus()}}</td>
                            <td>
                                <a href="{{route('contact_us.edit',$msg->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>@lang('site.edit')</a>
                                
                                <form method="post" action="{{route('contact_us.destroy',$msg->id)}}" style="display: inline-block">
                                    @csrf
                                    {{method_field('delete')}}
