                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="card2 card border-0 px-4 py-5">
                            <div class="row mb-4 px-3">
                                <h6 class="mb-0 mr-4 mt-2">التسجيل بواسطة</h6>
                            ...
                            <div class="row px-3 mb-4">
                                <div class="line"></div> <small class="or text-center">أو</small>
                                <div class="line"></div>
                            </div>
                            ...
                            <div class="row px-3"> <label class="mb-1" for="password-confirm">
                                    ...
                                    autocomplete="new-password" id="password-confirm" placeholder="إعادة كلمة المرور"
